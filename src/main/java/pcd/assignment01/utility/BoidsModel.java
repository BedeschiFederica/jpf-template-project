package pcd.assignment01.utility;
...
public class BoidsModel {
    ...
    public BoidsModel(final int nBoids,
        ...
        for (int i = 0; i < nBoids; i++) {
            ...
            final P2d pos = new P2d(-this.width/2 + (double)i/nBoids * this.width, -this.height/2 + (double)i/nBoids * this.height);
            final V2d vel = new V2d((double)i/nBoids * this.maxSpeed/2 - this.maxSpeed/4, (double)i/nBoids * this.maxSpeed/2 - this.maxSpeed/4);
